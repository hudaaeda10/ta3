...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::put('laporan/harian/update/{idproject}/{idsprint}/{idtask}', 'HarianController@update')->name('harian.update');
    ...
    Route::get('laporan/sprint/{idproject}/{idsprint}/create', 'LaporsprintController@create')->name('laporan.sprint.create');
    ...
    Route::get('laporan/sprint/{idreport}/{idproject}/{idsprint}/edit', 'LaporsprintController@edit')->name('laporan.sprint.edit');
